-- Approved answers to employer screening questions.
-- When the system or user resolves a question, the (label, answer) pair is saved here.
...
CREATE TABLE IF NOT EXISTS question_answer_cache (
    ...
    answer          TEXT NOT NULL,           -- approved answer text
    field_type      TEXT,                    -- 'radio', 'select', 'text', etc.
    source          TEXT DEFAULT 'human',    -- 'human' or 'llm'
