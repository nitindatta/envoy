...
from app.policy import linkedin as linkedin_policy
...
from app.tools.linkedin import search_linkedin
from app.tools.linkedin_detail import fetch_job_detail
...
class LinkedInAdapter:
    async def search(
        ...
        *,
        ...
        return await search_linkedin(client, keywords=keywords, location=location, max_pages=max_pages)
    ...
    def is_blocked(self, job: ProviderJob) -> BlockReason | None:
        return linkedin_policy.is_blocked(job)
